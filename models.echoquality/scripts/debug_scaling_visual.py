...
def main(file_path=None):
    ...
    if file_path is None:
        if len(sys.argv) > 1:
            ...
            print("DICOM Visual Debug Scaling Tool")
            print("=" * 50)
            print("This tool provides visual debugging for DICOM scaling issues.")
            print("It creates detailed visualizations with side-by-side comparisons")
            print("and shows problematic areas in the scaling process.")
            print("")
