...
DEBUG_DIR = Path("./results/debug_images_specialized")
...
def main(file_path=None):
    ...
    if file_path is None:
        if len(sys.argv) > 1:
            ...
            print("DICOM Specialized Debug Scaling Tool")
            print("=" * 50)
            print("This tool specializes in debugging scaling issues with unusually shaped DICOM images.")
            print("It focuses on problems with very narrow or wide images being scaled to square outputs.")
            print("")
