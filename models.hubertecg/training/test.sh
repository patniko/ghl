...
python ../tools/test.py /path/to/ptb_all_test.csv ../results 64 \
    ../weights/hubert_small_12.5k_ptbAll.pt \
...
python ../tools/test.py /path/to/ptb_all_test.csv ../results 64 \
    ../weights/hubert_base_9k_ptbAll.pt \
    --downsampling_factor=5 \
    --label_start_index=4 \
    --tta \
...
python ../tools/test.py /path/to/ptb_all_test.csv ../results 64 \
    ../weights/hubert_large_8.5k_ptbAll.pt \
    --downsampling_factor=5 \
    --label_start_index=4 \
    --tta \
