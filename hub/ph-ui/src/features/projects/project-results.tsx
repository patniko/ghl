...
export default function ProjectResults() {
  ...
  const { orgSlug, projectName } = useParams({ 
    from: '/_authenticated/$orgSlug/$projectName/results' 
  })
      ...
      <div className="mb-6 flex items-center md:hidden">
        ...
        {isLoading ? (
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold tracking-tight">{project.name} - Results</h1>
              <p className="text-muted-foreground">
                View and analyze results for this project
              </p>
            </div>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">No results found for this project.</p>
              </CardContent>
            </Card>
          </div>
        ) : (
