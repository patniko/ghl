...
const AuthenticatedOrgSlugIndexLazyImport = createFileRoute(
...
const AuthenticatedOrgSlugProjectNameLazyImport = createFileRoute(
  '/_authenticated/$orgSlug/$projectName',
)()
const AuthenticatedOrgSlugProjectNameIndexLazyImport = createFileRoute(
  '/_authenticated/$orgSlug/$projectName/',
)()
const AuthenticatedOrgSlugProjectNameTasksLazyImport = createFileRoute(
  '/_authenticated/$orgSlug/$projectName/tasks',
)()
const AuthenticatedOrgSlugProjectNameResultsLazyImport = createFileRoute(
  '/_authenticated/$orgSlug/$projectName/results',
)()
const AuthenticatedOrgSlugProjectNameConfigLazyImport = createFileRoute(
  '/_authenticated/$orgSlug/$projectName/config',
)()
const AuthenticatedOrgSlugProjectNameBatchesLazyImport = createFileRoute(
...
const AuthenticatedOrgSlugIndexLazyRoute =
  AuthenticatedOrgSlugIndexLazyImport.update({
    id: '/$orgSlug/',
    path: '/$orgSlug/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any).lazy(() =>
    import('./routes/_authenticated/$orgSlug/index.lazy').then((d) => d.Route),
  )
...
const AuthenticatedOrgSlugProjectsLazyRoute =
  AuthenticatedOrgSlugProjectsLazyImport.update({
    id: '/$orgSlug/projects',
    path: '/$orgSlug/projects',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any).lazy(() =>
    import('./routes/_authenticated/$orgSlug/projects.lazy').then(
      (d) => d.Route,
    ),
  )

const AuthenticatedOrgSlugProjectNameLazyRoute =
  AuthenticatedOrgSlugProjectNameLazyImport.update({
    id: '/$orgSlug/$projectName',
    path: '/$orgSlug/$projectName',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any).lazy(() =>
    import('./routes/_authenticated/$orgSlug/$projectName.lazy').then(
      (d) => d.Route,
    ),
  )

const AuthenticatedOrgSlugProjectNameIndexLazyRoute =
  AuthenticatedOrgSlugProjectNameIndexLazyImport.update({
    id: '/',
    path: '/',
    getParentRoute: () => AuthenticatedOrgSlugProjectNameLazyRoute,
  } as any).lazy(() =>
    import('./routes/_authenticated/$orgSlug/$projectName/index.lazy').then(
      (d) => d.Route,
    ),
  )

const AuthenticatedOrgSlugProjectNameTasksLazyRoute =
  AuthenticatedOrgSlugProjectNameTasksLazyImport.update({
    id: '/tasks',
    path: '/tasks',
    getParentRoute: () => AuthenticatedOrgSlugProjectNameLazyRoute,
  } as any).lazy(() =>
    import('./routes/_authenticated/$orgSlug/$projectName/tasks.lazy').then(
      (d) => d.Route,
    ),
  )

const AuthenticatedOrgSlugProjectNameResultsLazyRoute =
  AuthenticatedOrgSlugProjectNameResultsLazyImport.update({
    id: '/results',
    path: '/results',
    getParentRoute: () => AuthenticatedOrgSlugProjectNameLazyRoute,
  } as any).lazy(() =>
    import('./routes/_authenticated/$orgSlug/$projectName/results.lazy').then(
      (d) => d.Route,
    ),
  )

const AuthenticatedOrgSlugProjectNameConfigLazyRoute =
  AuthenticatedOrgSlugProjectNameConfigLazyImport.update({
    id: '/config',
    path: '/config',
    getParentRoute: () => AuthenticatedOrgSlugProjectNameLazyRoute,
  } as any).lazy(() =>
    import('./routes/_authenticated/$orgSlug/$projectName/config.lazy').then(
      (d) => d.Route,
    ),
  )

const AuthenticatedOrgSlugProjectNameBatchesLazyRoute =
  AuthenticatedOrgSlugProjectNameBatchesLazyImport.update({
    id: '/batches',
    path: '/batches',
    getParentRoute: () => AuthenticatedOrgSlugProjectNameLazyRoute,
  } as any).lazy(() =>
    import('./routes/_authenticated/$orgSlug/$projectName/batches.lazy').then(
      (d) => d.Route,
    ),
  )
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/$orgSlug/$projectName': {
      id: '/_authenticated/$orgSlug/$projectName'
      path: '/$orgSlug/$projectName'
      fullPath: '/$orgSlug/$projectName'
      preLoaderRoute: typeof AuthenticatedOrgSlugProjectNameLazyImport
      parentRoute: typeof AuthenticatedRouteImport
    }
    '/_authenticated/$orgSlug/projects': {
      id: '/_authenticated/$orgSlug/projects'
      path: '/$orgSlug/projects'
    ...
    '/_authenticated/$orgSlug/': {
      ...
      path: '/$orgSlug'
      fullPath: '/$orgSlug'
      preLoaderRoute: typeof AuthenticatedOrgSlugIndexLazyImport
      parentRoute: typeof AuthenticatedRouteImport
    }
    '/_authenticated/apps/': {
    ...
    '/_authenticated/$orgSlug/$projectName/batches': {
      id: '/_authenticated/$orgSlug/$projectName/batches'
      path: '/batches'
      fullPath: '/$orgSlug/$projectName/batches'
      preLoaderRoute: typeof AuthenticatedOrgSlugProjectNameBatchesLazyImport
      parentRoute: typeof AuthenticatedOrgSlugProjectNameLazyImport
    }
    '/_authenticated/$orgSlug/$projectName/config': {
      id: '/_authenticated/$orgSlug/$projectName/config'
      path: '/config'
      fullPath: '/$orgSlug/$projectName/config'
      preLoaderRoute: typeof AuthenticatedOrgSlugProjectNameConfigLazyImport
      parentRoute: typeof AuthenticatedOrgSlugProjectNameLazyImport
    }
    '/_authenticated/$orgSlug/$projectName/results': {
      id: '/_authenticated/$orgSlug/$projectName/results'
      path: '/results'
      fullPath: '/$orgSlug/$projectName/results'
      preLoaderRoute: typeof AuthenticatedOrgSlugProjectNameResultsLazyImport
      parentRoute: typeof AuthenticatedOrgSlugProjectNameLazyImport
    }
    '/_authenticated/$orgSlug/$projectName/tasks': {
      id: '/_authenticated/$orgSlug/$projectName/tasks'
      path: '/tasks'
      fullPath: '/$orgSlug/$projectName/tasks'
      preLoaderRoute: typeof AuthenticatedOrgSlugProjectNameTasksLazyImport
      parentRoute: typeof AuthenticatedOrgSlugProjectNameLazyImport
    }
    '/_authenticated/$orgSlug/$projectName/': {
      id: '/_authenticated/$orgSlug/$projectName/'
      path: '/'
      fullPath: '/$orgSlug/$projectName/'
      preLoaderRoute: typeof AuthenticatedOrgSlugProjectNameIndexLazyImport
      parentRoute: typeof AuthenticatedOrgSlugProjectNameLazyImport
    }
  }
}
...
interface AuthenticatedOrgSlugProjectNameLazyRouteChildren {
  AuthenticatedOrgSlugProjectNameBatchesLazyRoute: typeof AuthenticatedOrgSlugProjectNameBatchesLazyRoute
  AuthenticatedOrgSlugProjectNameConfigLazyRoute: typeof AuthenticatedOrgSlugProjectNameConfigLazyRoute
  AuthenticatedOrgSlugProjectNameResultsLazyRoute: typeof AuthenticatedOrgSlugProjectNameResultsLazyRoute
  AuthenticatedOrgSlugProjectNameTasksLazyRoute: typeof AuthenticatedOrgSlugProjectNameTasksLazyRoute
  AuthenticatedOrgSlugProjectNameIndexLazyRoute: typeof AuthenticatedOrgSlugProjectNameIndexLazyRoute
}

const AuthenticatedOrgSlugProjectNameLazyRouteChildren: AuthenticatedOrgSlugProjectNameLazyRouteChildren =
  {
    AuthenticatedOrgSlugProjectNameBatchesLazyRoute:
      AuthenticatedOrgSlugProjectNameBatchesLazyRoute,
    AuthenticatedOrgSlugProjectNameConfigLazyRoute:
      AuthenticatedOrgSlugProjectNameConfigLazyRoute,
    AuthenticatedOrgSlugProjectNameResultsLazyRoute:
      AuthenticatedOrgSlugProjectNameResultsLazyRoute,
    AuthenticatedOrgSlugProjectNameTasksLazyRoute:
      AuthenticatedOrgSlugProjectNameTasksLazyRoute,
    AuthenticatedOrgSlugProjectNameIndexLazyRoute:
      AuthenticatedOrgSlugProjectNameIndexLazyRoute,
  }

const AuthenticatedOrgSlugProjectNameLazyRouteWithChildren =
  AuthenticatedOrgSlugProjectNameLazyRoute._addFileChildren(
    AuthenticatedOrgSlugProjectNameLazyRouteChildren,
  )
...
export interface FileRoutesByFullPath {
  ...
  '/$orgSlug': typeof AuthenticatedOrgSlugIndexLazyRoute
  ...
  '/$orgSlug/$projectName/batches': typeof AuthenticatedOrgSlugProjectNameBatchesLazyRoute
  '/$orgSlug/$projectName/config': typeof AuthenticatedOrgSlugProjectNameConfigLazyRoute
  '/$orgSlug/$projectName/results': typeof AuthenticatedOrgSlugProjectNameResultsLazyRoute
  '/$orgSlug/$projectName/tasks': typeof AuthenticatedOrgSlugProjectNameTasksLazyRoute
  '/$orgSlug/$projectName/': typeof AuthenticatedOrgSlugProjectNameIndexLazyRoute
}
...
export interface FileRoutesById {
  ...
  '/_authenticated/$orgSlug/': typeof AuthenticatedOrgSlugIndexLazyRoute
  ...
  '/_authenticated/$orgSlug/$projectName/batches': typeof AuthenticatedOrgSlugProjectNameBatchesLazyRoute
  '/_authenticated/$orgSlug/$projectName/config': typeof AuthenticatedOrgSlugProjectNameConfigLazyRoute
  '/_authenticated/$orgSlug/$projectName/results': typeof AuthenticatedOrgSlugProjectNameResultsLazyRoute
  '/_authenticated/$orgSlug/$projectName/tasks': typeof AuthenticatedOrgSlugProjectNameTasksLazyRoute
  '/_authenticated/$orgSlug/$projectName/': typeof AuthenticatedOrgSlugProjectNameIndexLazyRoute
}
...
export interface FileRouteTypes {
  ...
  fullPaths:
    ...
    | '/tasks'
    | '/users'
    | '/$orgSlug/$projectName/batches'
    | '/$orgSlug/$projectName/config'
    | '/$orgSlug/$projectName/results'
    | '/$orgSlug/$projectName/tasks'
    | '/$orgSlug/$projectName/'
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_authenticated/$orgSlug/$projectName": {
      "filePath": "_authenticated/$orgSlug/$projectName.lazy.tsx",
      "parent": "/_authenticated",
      "children": [
        "/_authenticated/$orgSlug/$projectName/batches",
        "/_authenticated/$orgSlug/$projectName/config",
    ...
    "/_authenticated/$orgSlug/": {
      "filePath": "_authenticated/$orgSlug/index.lazy.tsx",
      "parent": "/_authenticated"
    },
    "/_authenticated/apps/": {
    ...
    "/_authenticated/$orgSlug/$projectName/batches": {
      "filePath": "_authenticated/$orgSlug/$projectName/batches.lazy.tsx",
      "parent": "/_authenticated/$orgSlug/$projectName"
    },
    "/_authenticated/$orgSlug/$projectName/config": {
      "filePath": "_authenticated/$orgSlug/$projectName/config.lazy.tsx",
      "parent": "/_authenticated/$orgSlug/$projectName"
    },
    "/_authenticated/$orgSlug/$projectName/results": {
      "filePath": "_authenticated/$orgSlug/$projectName/results.lazy.tsx",
      "parent": "/_authenticated/$orgSlug/$projectName"
    },
    "/_authenticated/$orgSlug/$projectName/tasks": {
      "filePath": "_authenticated/$orgSlug/$projectName/tasks.lazy.tsx",
      "parent": "/_authenticated/$orgSlug/$projectName"
    },
    "/_authenticated/$orgSlug/$projectName/": {
      "filePath": "_authenticated/$orgSlug/$projectName/index.lazy.tsx",
      "parent": "/_authenticated/$orgSlug/$projectName"
    }
  }
}
